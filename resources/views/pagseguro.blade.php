...
<html lang="pt-br">
    ...
    <meta charset="utf-8">
        ...
        <!-- Title / Icon -->
        <title>Gerenciador-Cep 3.0 - Pagseguro</title>
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <form action="{{ route('plano') }}" method="post">
                                        @csrf
                                        <input id="cep" class="form form-control" type="text" name="cep" placeholder="Insira o CEP (Apenas use números):">
                                            <div class="row">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <h4>Boleto</h4>
                                    <form action="{{ route('boleto') }}" method="post">
                                        @csrf
                                        <input id="cep" class="form form-control" type="text" name="cep" placeholder="Insira o CEP (Apenas use números):">
                                            <div class="row">
