...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Gerenciador-Cep 3.0</title>
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">       
                <a href="{{ route('view.login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Entrar</a>

                <a href="{{ route('view.register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Registrar</a>
            </div>

            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <img src="https://i.pinimg.com/736x/2e/d5/7a/2ed57accf63d08e5ebb1ee853bed1832.jpg" class="logo">
                    <h1>Gerenciador CEP</h1>
                </div>
